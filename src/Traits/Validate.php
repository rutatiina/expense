...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $dataCustomMessages = [
            ...
            'credit_financial_account_code.required' => "Financial account to credit is required",
            'debit_financial_account_code.numeric' => "Financial account to debit must be numeric",
            'credit_financial_account_code.numeric' => "Financial account to credit must be numeric",
        ];
        ...
        $this->txn['debit_financial_account_code'] = $data['debit_financial_account_code']; //optional($this->settings->financial_account_to_debit)->code;
        $this->txn['credit_financial_account_code'] = $data['credit_financial_account_code']; //optional($this->settings->financial_account_to_credit)->code;
