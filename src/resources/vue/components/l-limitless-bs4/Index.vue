        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Expenses</span></h4>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="row in tableData.payload.data"
                                ...
                                <td class="cursor-pointer">{{row.number_string}}</td>
...
<script>
    ...
    export default {
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/expenses/'+txn.id })
            }
        },
        ready:function(){},
